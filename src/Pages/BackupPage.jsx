...
const formatDate = (dateString) => {
  const [date] = dateString.split(" ");     // removes time
...
const getNewsDetails = async () => {
  const res = await axios.get(
    apiBaseUrl("XpressNews/GetXpressNewsDetails/20"),
    {
      headers: {
...
export default function NewsDetails() {
                ...
                <div className="row g-5 align-items-center justify-content-between">
                    <div className="col-xl-9 col-lg-8 col-md-12 col-12 mt-4">
                        {newsData.map((item , index) =>(
                            ...
                            <h3 className="italic-text">{item.title}</h3>
  ...
  {formatDate(newsData.newsDate)} | {newsData.readTime}
</p>
                            ...
                            <div className="news-details-main-img">
                                <div className="image-wrapper">
                                    <img src={imagePath} alt="Banner" className="banner-img-details" />
